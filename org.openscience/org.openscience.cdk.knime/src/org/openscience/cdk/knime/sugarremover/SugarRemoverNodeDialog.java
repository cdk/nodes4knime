...
import org.openscience.cdk.knime.atomsignature.AtomSignatureSettings;
...
public class SugarRemoverNodeDialog extends NodeDialogPane {
    ...
    /**
     * New pane for configuring SugarRemover node dialog.
                ...
                if (m_appendColumnChecker.isSelected()) {
                    ...
                    if ("".equals(m_appendColumnName.getText())) {
                        m_appendColumnName.setText(
                                m_molColumn.getSelectedColumn() + " (light)");
                    }
                } else {
