 ...
 * @author ldpf
 */
public class SugarRemoverNodeFactory 
        extends NodeFactory<SugarRemoverNodeModel> {
     ...
     */
    @Override
    public NodeView<SugarRemoverNodeModel> createNodeView(final int viewIndex,
            final SugarRemoverNodeModel nodeModel) {
        return null;
    }
