 ...
 */
public abstract class AbstractSinglePropertyNodeFactory extends
        NodeFactory<SinglePropertyNodeModel> {
     ...
     */
    @Override
    public NodeView<SinglePropertyNodeModel> createNodeView(
            final int viewIndex, final SinglePropertyNodeModel nodeModel) {
