...
public class FingerprintNodeModel extends NodeModel {
    ...
    private ColumnRearranger createColumnRearranger(final DataTableSpec spec)
        ...
        String newColName = m_settings.fingerprintType() + " fingerprints for "
            + s;
        ...
        } else if (m_settings.fingerprintType()
                .equals(FingerprintTypes.Pubchem)) {
        ...
        DataColumnSpecCreator c =
                new DataColumnSpecCreator(newColName, DenseBitVectorCell.TYPE);
        ...
        SingleCellFactory cf = new SingleCellFactory(appendSpec) {
            ...
            public DataCell getCell(final DataRow row) {
                ...
                try {
                    ...
                    for (int i = fingerprint.nextSetBit(0); i >= 0; i =
                            fingerprint.nextSetBit(i + 1)) {
                        bitVector.set(i);
                    }
