...
public class FingerprintNodeDialog extends NodeDialogPane {
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        m_molColumn.update(specs[0], m_settings.molColumn());
        if (m_settings.fingerprintType().equals(FingerprintTypes.Standard)) {
            m_standardFP.setSelected(true);
        } else if (m_settings.fingerprintType().equals(
                FingerprintTypes.Extended)) {
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings)
        ...
        m_settings.molColumn(m_molColumn.getSelectedColumn());
