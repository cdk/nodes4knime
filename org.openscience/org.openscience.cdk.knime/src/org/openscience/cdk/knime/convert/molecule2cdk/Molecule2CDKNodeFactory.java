...
/**
 * This is the factory for the Molecule->CDK node.
 * 
...
public class Molecule2CDKNodeFactory extends NodeFactory<Molecule2CDKNodeModel> {
	 ...
	 */
	@Override
	public Molecule2CDKNodeModel createNodeModel() {
	 ...
	 */
	@Override
	public NodeView<Molecule2CDKNodeModel> createNodeView(final int index, final Molecule2CDKNodeModel model) {
