...
/**
 * Cell factory generating and evaluating molecular formulas based on a given
 * mass.
 * 
 * @author sab
 * 
...
public class SumFormulaGenerator implements CellFactory {
	 ...
	 * 
	 * @param dataColumnSpec data column specifications of the columns to be
	 *        appended
	 * @param massColIndex column index of the mass containing column
	 * @param exclude boolean if unvalidated formulas should be included in the
	 *        output
	 */
