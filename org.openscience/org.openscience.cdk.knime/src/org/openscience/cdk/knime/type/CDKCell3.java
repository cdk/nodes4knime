...
public final class CDKCell3 extends DataCell implements CDKValue, SmilesValue, SdfValue, StringValue {
	 ...
	 */
	public static final DataType TYPE = DataType.getType(CDKCell3.class);
	...
	private static final NodeLogger LOGGER = NodeLogger.getLogger(CDKCell3.class);
	 ...
	 */
	private static final DataCellSerializer<CDKCell3> SERIALIZER = new CDKSerializer();
	 ...
	 * @see DataCell
	 */
	public static final DataCellSerializer<CDKCell3> getCellSerializer() {
		return SERIALIZER;
	}
	...
	public static DataCell createCDKCell(final IAtomContainer atomContainer) {
		return new CDKAdapterCell(new CDKCell3(atomContainer));
	}
	...
	public static DataCell createCDKCell(final DataCell source, final IAtomContainer atomContainer) {
		return new CDKAdapterCell((AdapterValue) source, new CDKCell3(atomContainer));
	}
	 ...
	 */
	public CDKCell3(final IAtomContainer atomContainer) {
	 ...
	 */
	public CDKCell3(final String smiles, final long hash, final byte[] coordinates) {
		this.smiles = smiles;
		this.hash = hash;
	 ...
	 */
	private static class CDKSerializer implements DataCellSerializer<CDKCell3> {

		/**
		 * {@inheritDoc}
		 */
		@Override
		public void serialize(final CDKCell3 cell, final DataCellDataOutput out) throws IOException {
		 ...
		 */
		@Override
		public CDKCell3 deserialize(final DataCellDataInput input) throws IOException {
			...
			if (((bytes)[0] == (byte) (GZIPInputStream.GZIP_MAGIC))
				...
				return new CDKCell3(mol); // create new CDK cell
				...
				return new CDKCell3(smiles, hash64, coords);
			}
		}
	}
