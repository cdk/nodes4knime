 ...
 */
public final class CDKCell2 extends DataCell implements CDKValue, SmilesValue, SdfValue, StringValue {
	 ...
	 */
	public static final DataType TYPE = DataType.getType(CDKCell2.class);
	...
	private static final NodeLogger LOGGER = NodeLogger.getLogger(CDKCell2.class);
	 ...
	 */
	private static final DataCellSerializer<CDKCell2> SERIALIZER = new CDKSerializer();
	 ...
	 * @see DataCell
	 */
	public static final DataCellSerializer<CDKCell2> getCellSerializer() {
		return SERIALIZER;
	}
	...
	public static DataCell createCDKCell(final IAtomContainer atomContainer) {
		return new CDKAdapterCell(new CDKCell2(atomContainer));
	}
	...
	public static DataCell createCDKCell(final DataCell source, final IAtomContainer atomContainer) {
		return new CDKAdapterCell((AdapterValue) source, new CDKCell2(atomContainer));
	}
	 ...
	 */
	public CDKCell2(final IAtomContainer atomContainer) {
	 ...
	 */
	public CDKCell2(final String smiles, final long hash, final byte[] coordinates) {
		this.smiles = smiles;
		this.hash = hash;
	 ...
	 */
	private static class CDKSerializer implements DataCellSerializer<CDKCell2> {

		/**
		 * {@inheritDoc}
		 */
		@Override
		public void serialize(final CDKCell2 cell, final DataCellDataOutput out) throws IOException {
		 ...
		 */
		@Override
		public CDKCell2 deserialize(final DataCellDataInput input) throws IOException {
			...
			if (((bytes)[0] == (byte) (GZIPInputStream.GZIP_MAGIC))
				...
				return new CDKCell2(mol); // create new CDK cell
				...
				return new CDKCell2(smiles, hash64, coords);
			}
		}
	}
