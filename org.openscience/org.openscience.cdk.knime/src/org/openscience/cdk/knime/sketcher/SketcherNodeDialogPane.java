...
public class SketcherNodeDialogPane extends NodeDialogPane {
    ...
    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(SketcherNodeDialogPane.class);
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        String[] smiles =
                settings.getStringArray(SketcherNodeModel.CFG_STRUCTURE,
                        (String[])null);
        if (smiles != null) {
            try {
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings)
        ...
        settings.addStringArray(SketcherNodeModel.CFG_STRUCTURE, m_panel
                .getAllSmiles());
    }
}
