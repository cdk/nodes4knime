/* Created on 30.01.2007 17:32:51 by thor
 * ------------------------------------------------------------------------
 *
...
/**
 * This class is the factory for the connectivity node that creates all
 * necessary objects.
 *
...
public class ConnectivityNodeFactory extends NodeFactory<ConnectivityNodeModel> {
     ...
     */
    @Override
    public NodeView<ConnectivityNodeModel> createNodeView(final int viewIndex,
            final ConnectivityNodeModel nodeModel) {
        return null;
    }
