...
/**
 * This class provides the dialog for the connectivity node. It allows choosing
 * the molecule column and how rows with fragmented should be treated.
 *
...
public class ConnectivityNodeDialog extends NodeDialogPane {
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        m_removeSmallParts.setSelected(!m_settings.removeCompleteRow()
                && !m_settings.addFragmentColumn());
